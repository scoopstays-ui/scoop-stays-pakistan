...
export const properties: Property[] = [
  ...
  },
  {
    ...
    type: "Farmhouse",
    amenities: ["WiFi", "Hot & Cold Water", "Comfortable Bedrooms", "Spacious Living Area", "Kitchen Facilities", "Outdoor Sitting Area", "Parking Space", "All Basic Living Facilities"],
    description: "Pine Tree House is a peaceful 2-bedroom farmhouse located in Murree, surrounded by natural beauty and fresh mountain air. Built on a spacious 1 kanal property, this farmhouse is perfect for families and small groups looking for a relaxing getaway. Guests can enjoy a comfortable stay close to nature while still being within reach of Murree's popular tourist attractions. This property is ideal for family vacations, weekend retreats, and peaceful stays in the mountains.",
    lat: 33.7549479,
    lng: 73.4191821,
